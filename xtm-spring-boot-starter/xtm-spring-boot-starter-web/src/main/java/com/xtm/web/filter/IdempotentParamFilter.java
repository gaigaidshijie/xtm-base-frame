...
import com.xtm.common.context.ContextHolder;
import com.xtm.web.wrapper.KittyRequestWrapper;
...
/**
 * <p>Description:[幂等参数过滤器，负责接收前端传递的幂等ID，如果没传递则生成幂等ID] </p>
 *
 * Created on : 2020/8/6 16:45
 *
