...
public class CatMonitorRedisConnection implements RedisConnection {
    ...
    @Override
    public List<ByteRecord> xRange(byte[] bytes, org.springframework.data.domain.Range<String> range, Limit limit) {
        return null;
    }

    @Override
    public List<ByteRecord> xRead(StreamReadOptions streamReadOptions, StreamOffset<byte[]>... streamOffsets) {
        return null;
    }

    @Override
    public List<ByteRecord> xReadGroup(Consumer consumer, StreamReadOptions streamReadOptions, StreamOffset<byte[]>... streamOffsets) {
        return null;
    }

    @Override
    public List<ByteRecord> xRevRange(byte[] bytes, org.springframework.data.domain.Range<String> range, Limit limit) {
        return null;
    }
