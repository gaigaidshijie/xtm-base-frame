package com.xtm.log.aspect;

import cn.hutool.core.util.IdUtil;
import com.xtm.log.annotation.AuditLog;
...
/**
 * <p>Description:[审计日志切面] </p>
 * Created on : 2020/8/17 11:38
 *
...
public class AuditLogAspect {
    ...
    public void beforeMethod(JoinPoint joinPoint, AuditLog auditLog) {
        ...
        if (auditLogProperties.getEnabled()) {
            ...
            com.xtm.log.model.AuditLog audit = getAudit(auditLog, joinPoint);
     ...
     * 构建审计对象
     */
    private com.xtm.log.model.AuditLog getAudit(AuditLog auditLog, JoinPoint joinPoint) {
        com.xtm.log.model.AuditLog audit = new com.xtm.log.model.AuditLog();
        audit.setId(IdUtil.objectId());
        audit.setCreateTime(LocalDateTime.now().toString());
        ...
        String userName = (String) request.getAttribute("x-user-header");
